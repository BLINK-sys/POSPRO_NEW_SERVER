...
PRESET_RF = '(себестоимость * курс_валюты * 1.16 + доставка) * коэф_наценки'
PRESET_KZ_VAT = '(себестоимость + доставка) * коэф_наценки'
PRESET_KZ_NOVAT = '(себестоимость + доставка) * коэф_наценки'
