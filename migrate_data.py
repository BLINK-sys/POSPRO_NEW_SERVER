#!/usr/bin/env python3
"""
Скрипт для миграции данных из локальной PostgreSQL базы в базу на Render
"""
...
# База данных на Render (замените на вашу)
RENDER_DB_URL = os.getenv("RENDER_DATABASE_URL")  # Установите эту переменную в .env
